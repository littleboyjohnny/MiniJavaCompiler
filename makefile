ast: lex.yy.c parser.tab.c AST/ASTVisualiser.cpp
	g++ -ggdb -std=c++17 lexer/lex.yy.c parser/parser.tab.c lexer/lexer.cpp parser/parser.cpp astBuilder.cpp AST/ASTBuilder.cpp AST/ASTVisualiser.cpp -o build/tree.out
