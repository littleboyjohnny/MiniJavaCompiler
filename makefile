parser: lex.yy.c parser.tab.c
	g++ -ggdb -DPARSER_MAIN -DPARSER_DEBUG lexer/lex.yy.c parser/parser.tab.c lexer/lexer.cpp parser/parser.cpp -o build/parser.out

lexer: lex.yy.c parser.tab.c
	g++ -ggdb -DLEXER_MAIN -DLEXER_DEBUG lexer/lex.yy.c parser/parser.tab.c lexer/lexer.cpp parser/parser.cpp -o build/lexer.out
